...
const USER_EVENT_CONTRACT_ADDRESS =
  process.env.USER_EVENT_CONTRACT_ADDRESS || "";
...
const handleGET = async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  const contract = new ethers.Contract(
    USER_EVENT_CONTRACT_ADDRESS,
    SEND_WALLET_CONTRACT_ABI.abi,
    provider
  );

  await contract.interactWithCampaign(
    user_wallet_address,
